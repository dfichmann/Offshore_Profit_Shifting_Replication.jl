...
* November 18, 2021
* This file prepares the 2008 BE15 data on US affiliates, 
...
odbc load if PrdName=="2008" & Vintage=="r", clear table("U_BE15FormData") connectionstring("Driver={SQL Server};Server={DidProdB17};Trusted_Connection={Yes};Database={Ue_Result};UID=oddgr1")
destring(*), replace
...
* save file of 2008 US Aff data

ren PrdName year
sort UsId year
save USAffs2008, replace
