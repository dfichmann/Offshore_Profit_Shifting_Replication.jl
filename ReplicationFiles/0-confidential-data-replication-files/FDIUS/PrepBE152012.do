...
* November 18, 2021
* This file prepares the 2012 BE15 data on US affiliates, 
...
odbc load if PrdName=="2012" & Vintage=="r", clear table("U_BE15FormData") connectionstring("Driver={SQL Server};Server={DidProdB17};Trusted_Connection={Yes};Database={Ue_Result};UID=oddgr11")
destring(*), replace
...
* save file of 2012 US Aff data

ren PrdName year
sort UsId year
save USAffs2012, replace
